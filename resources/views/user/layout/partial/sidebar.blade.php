<div class="main-sidebar">
        ...
        <section class="sidebar" id="sidebar">
            ...
            <ul class="tree pl-1">
                ...
                <li class="has-children p-1 pt-2">
                    <button class="tag-sidebar" id="course" href="{{ url('courses') }}"><img class="icontree" src="{{ asset('user/images/books-stack-of-three.png') }}" />
                    Courses</button>
                </li>
        ...
        <button class="tag-sidebar" id="course-mobile" href="{{ url('courses') }}"><img class="icontree" src="{{ asset('user/images/books-stack-of-three.png') }}" />
        Courses</button>
